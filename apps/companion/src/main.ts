...
import { startSpeechSetup, stopSpeechSetup } from "./providers/speech-model";
...
void tick();
function stop() { clearInterval(timer); stopSpeechSetup(); stopSpeech(); app.stop(); db.close(); process.exit(0); }
